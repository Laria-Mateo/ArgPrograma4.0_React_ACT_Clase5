        ...
        <Box w={['full','md']} p={[8,10]} mt={[20,'10vh']} mb={[20,'10vh']}  mx='auto' border={['none','1px']}
          ...
          <VStack spacing={4} w='full'>
            ...
            <HStack spacing={4} align='center'>
              <Button flex={1} colorScheme='facebook' onClick={AumentarContador}>Aumentar</Button>
              <Button flex={1} colorScheme='facebook' onClick={DecrementarContador}>Decrementar</Button>
            </HStack>
